...
<body>
	<div class="navbar navbar-fixed-top navbar-inverse">
		<div class="navbar-inner">
			<div class="container">
				<a class="brand" href="#"> <spring:message code="minutes.exercised" />
				</a>
				<ul class="nav">
				</ul>
			</div>
	...
	<div class="container">
		...
		<a class="btn" href="?language=en"> English </a> <a class="btn" href="?language=es"> Spanish </a> <br /> <br />
		<form:form commandName="exercise">
			...
			<div class="control-group">
				<label for="selectinput1"> <spring:message code="minutes.activity" />
				</label>
		...
		<span class="label"> <spring:message code="minutes.goal" /> ${goal.minutes}
		</span>
	</div>
